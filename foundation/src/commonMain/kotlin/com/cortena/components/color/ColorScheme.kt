 ...
 *
 * Semantic color roles. Components consume these roles, not raw [ColorTokens].
 * This decouples components from specific palette values — swapping a theme
 * only requires providing a different [ColorScheme] instance.
 *
 * Each property is a Long (ARGB) to stay framework-agnostic.
 * Compose layer converts these to androidx.compose.ui.graphics.Color.
 */
