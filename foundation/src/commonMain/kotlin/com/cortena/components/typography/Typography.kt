...
/**
 * Cortena Components — Typography
 *
 * Semantic typography roles. Maps [TypeScale] values to named roles
 * that components consume. Framework-agnostic data class.
 */
...
data class Typography(
    val displayLarge: TextStyle = TextStyle(
        ...
        TypeScale.LineHeightDisplayLarge
    ),
    val displayMedium: TextStyle = TextStyle(
        TypeScale.DisplayMedium,
        TypeScale.LineHeightDisplayMedium
    ),
    val displaySmall: TextStyle = TextStyle(
        TypeScale.DisplaySmall,
        TypeScale.LineHeightDisplaySmall
    ),

    val headlineLarge: TextStyle = TextStyle(
        TypeScale.HeadlineLarge,
        TypeScale.LineHeightHeadlineLarge
    ),
    val headlineMedium: TextStyle = TextStyle(
        TypeScale.HeadlineMedium,
        TypeScale.LineHeightHeadlineMedium
    ),
    val headlineSmall: TextStyle = TextStyle(
        TypeScale.HeadlineSmall,
        TypeScale.LineHeightHeadlineSmall
    ),
