        ...
        with(density) {
            when (layoutDirection) {
                LayoutDirection.Ltr -> {
                    ...
                    if (bottomEnd.isSpecified) bottomRight =
                        bottomEnd.toPx().fastCoerceIn(0f, maxRadius)
                    if (bottomStart.isSpecified) bottomLeft =
                        bottomStart.toPx().fastCoerceIn(0f, maxRadius)
                }
                ...
                LayoutDirection.Rtl -> {
                    ...
                    if (bottomEnd.isSpecified) bottomLeft =
                        bottomEnd.toPx().fastCoerceIn(0f, maxRadius)
                    if (bottomStart.isSpecified) bottomRight =
                        bottomStart.toPx().fastCoerceIn(0f, maxRadius)
                }
            }
        }
