package framework.cortena.ui.graphics.shadow.internal
...
internal class ShadowElement(val shapeProvider: ShapeProvider, val shadow: () -> Shadow?) :
...
internal class ShadowNode(var shapeProvider: ShapeProvider, var shadow: () -> Shadow?) :
